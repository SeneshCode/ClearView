 ...
 * @author USER
 */
public class OptometristDashboard extends javax.swing.JFrame {
    ...
    public OptometristDashboard(String username, String fname, String lname) {
        initComponents();
        window = this;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/clearview/resources/Home.png"))); // NOI18N
...
//        FlatMaterialDeepOceanIJTheme.setup();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OptometristDashboard adminDashboard = new OptometristDashboard("200328712369", "senesh", "pawan");
