...
import lk.clearview.dialog.receptionist.Patient;
import lk.clearview.dialog.receptionist.RegisterNewPatient;
import lk.clearview.dialog.receptionist.UpdateNewPatient;
...
public class ManagePatient extends javax.swing.JPanel {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        UpdateNewPatient unp = new UpdateNewPatient(ReceptionistDashboard.window, true);
        unp.setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount()==2){
            ...
            Patient p = new Patient(ReceptionistDashboard.window, true);
            p.setVisible(true);
        } 
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        RegisterNewPatient rnp = new RegisterNewPatient(ReceptionistDashboard.window, true);
        rnp.setVisible(true);
