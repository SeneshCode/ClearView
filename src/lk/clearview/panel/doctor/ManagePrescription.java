...
public class ManagePrescription extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AddPrescription pr = new AddPrescription(DoctorDashboard.window, true);
        pr.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         UpdatePrescriptin pr = new UpdatePrescriptin(DoctorDashboard.window, true);
        pr.setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount()==2){
            PatientPrescription pp = new PatientPrescription(DoctorDashboard.window, true);
            pp.setVisible(true);
    }
